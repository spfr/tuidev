...
> **Note**: This setup uses terminal-based AI tools (claude, codex, gemini, opencode) in separate Zellij/tmux panes rather than in-editor AI plugins. This keeps nvim fast and focused on editing.
